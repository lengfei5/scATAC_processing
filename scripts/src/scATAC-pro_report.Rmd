...
output:
  flexdashboard::flex_dashboard:
    ...
    theme: united
params:
  output_dir: /groups/cochella/jiwang/Projects/Aleks/R8898_scATAC/output
  configure_user: /groups/cochella/jiwang/scripts/scATAC_pro/scATAC-pro_1.1.0/configure_user.txt
